...
def performance(unit: Literal['s', 'ms', 'ns'] = 'ms') -> Callable[[Callable], Callable[..., tuple[float, Any]]]:
    """
    ...
    def wrapper_1(func: Callable) -> Callable[..., tuple[float, Any]]:
        def wrapper_2() -> tuple[float, Any]:
